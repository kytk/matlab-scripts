% spect_norm_batch.m
% batch script for normalizing ECD SPECT
...
%% Select T1 files
imglist = spm_select(Inf,'image','Select SPECT files');
...
for i=1:size(imglist,1)
    ...
    matlabbatch{1}.spm.tools.oldnorm.estwrite.eoptions.template = {fullfile(spm('Dir'),'toolbox/OldNorm/ECD.nii,1')};
