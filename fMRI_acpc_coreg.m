...
% 2. Coregistration of the image to EPI.nii under spm/toolbox/OldNrom/EPI.nii
% 
% K. Nemoto 1/Apr/2018
...
%% Select Image files
imglist=spm_select(Inf,'image','Choose images you want to set AC-PC');

%% First, set the origin to the center of the image
...
%% Then, Coregister with icbm152.nii under spm12/toolbox/DARTEL
for i=1:size(imglist,1)
    matlabbatch{i}.spm.spatial.coreg.estimate.ref = {fullfile(spm('dir'),'toolbox','OldNorm','EPI.nii,1')};
